...
class RobotSegVideoPredictor(RobotSegBase):
    ...
    def init_state(
        ...
        inference_state["robot_inputs_per_obj"] = {}
    ...
    def _obj_id_to_idx(self, inference_state, obj_id):
        ...
        if allow_new_object:
            ...
            inference_state["robot_inputs_per_obj"][obj_idx] = {}
    ...
    def add_new_points_or_box(
        ...
        robot_inputs_per_frame = inference_state["robot_inputs_per_obj"][obj_idx]
        ...
        current_out, _ = self._run_single_frame_inference(
            ...
            robot_inputs=robots,  # Each frame is guided by the robot prompt
    ...
    # Use the robot prompt to guide each frame
    @torch.inference_mode()
    def propagate_in_video(
        ...
        for frame_idx in processing_order:
            ...
            for obj_idx in range(batch_size):
                ...
                if frame_idx in obj_output_dict["cond_frame_outputs"]:
                ...
                elif frame_idx in obj_output_dict["non_cond_frame_outputs"] and obj_output_dict["non_cond_frame_outputs"][frame_idx].get("frozen", False):
                    ...
                    current_out, pred_masks = self._run_single_frame_inference(
                        ...
                        robot_inputs=robot,  # Each frame can receive guidance
                        point_inputs=None,
                        mask_inputs=None,
                        reverse=reverse,
    ...
    def clear_all_prompts_in_frame(
        ...
        inference_state["robot_inputs_per_obj"][obj_idx].pop(frame_idx, None)
    ...
    def reset_state(self, inference_state):
        ...
        inference_state["robot_inputs_per_obj"].clear()
    ...
    def _reset_tracking_results(self, inference_state):
        ...
        for v in inference_state["robot_inputs_per_obj"].values():
            v.clear()
    ...
    def remove_object(self, inference_state, obj_id, strict=False, need_output=True):
        ...
        obj_input_frames_inds.update(
            inference_state["robot_inputs_per_obj"][old_obj_idx_to_rm]
        )
        obj_input_frames_inds.update(
        ...
        _map_keys(inference_state["robot_inputs_per_obj"])
