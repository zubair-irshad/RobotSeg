...
class BatchedVideoDatapoint:
    ...
    Attributes:
        ...
        categories: list  # added for VRS, 2D list: [T][O]
    """
...
def collate_fn(
    ...
    # added for VRS
    step_t_categories = [[] for _ in range(T)]  # newly added
    ...
    for video_idx, video in enumerate(batch):
        ...
        for t, frame in enumerate(video.frames):
            ...
            for obj in objects:
                ...
                step_t_categories[t].append(obj.category)  # newly added
    ...
    return BatchedVideoDatapoint(
        ...
        dict_key=dict_key,
        batch_size=[T],
        categories=step_t_categories,  # newly added
    )
