...
class MultiplePNGSegmentLoader:
    ...
    def _load_single_png(self, frame_id):
        ...
        if os.path.exists(mask_path):
            ...
            print("No mask found, use full-one-mask.")
            mask = np.ones((self.H, self.W), dtype=bool)  # incorrect sampling will cause the trained model to produce all-white outputs
