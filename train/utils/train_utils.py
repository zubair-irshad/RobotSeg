...
def collect_dict_keys(config):
    """This function recursively iterates through a dataset configuration and collects all the dict_key that are defined"""
    val_keys = []
    # If this config points to the collate function, then it has a key
