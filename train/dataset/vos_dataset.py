...
from train.dataset.vos_raw_dataset import VOSRawDataset
from train.dataset.vos_sampler import VOSSampler
from train.dataset.vos_segment_loader import JSONSegmentLoader
from train.utils.data_utils import Frame, Object, VideoDatapoint
            ...
            for obj_id in sampled_object_ids:
                ...
                images[frame_idx].objects.append(
                    Object(
                        ...
                        segment=segment,
                        category=getattr(video, "category", None),  # <--- 只加这一行
                    )
                )
